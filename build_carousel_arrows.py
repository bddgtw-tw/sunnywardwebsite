...
css_to_inject = """
/* Slider Replaced with Navigation Arrows */
.photo-carousel-wrap {
  margin-top: 1.5rem;
  width: 100%;
  position: relative;
...
def update_html(filepath, lang):
    ...
    # We clean up any duplicate or orphaned JavaScript from previous runs
    ...
    if match:
        ...
        # Inject JavaScript helper just before </body> (ensure no duplicates)
...
print("Successfully fixed javascript scope and scroll-snap compatibility.")
