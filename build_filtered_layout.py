...
# Language specific UI strings for filters
filter_strings = {
    'en': {
        'all': 'All Spaces',
        'fb': 'Dining / F&B',
...
@media (max-width: 768px) {
  .scrollspy-dots {
    display: none; /* Hide floating navigator on mobile */
  }
}
"""
...
function triggerIntersectionObserver(visibleSections) {
  ...
  const observerOptions = {
    root: null,
    rootMargin: '-20% 0px -40% 0px', // focused in the middle-top area of screen
    threshold: 0.1
  };
...
'''
    for idx, case in enumerate(lang_data):
        ...
        # Inject space and product categories into HTML5 data attributes for filtering
        html += f'''
...
def update_html(filepath, lang):
    ...
    if match:
        ...
        # Inject JavaScript helper just before </body>
...
print("Successfully generated layout with dual filters and scrollspy sidebar.")
