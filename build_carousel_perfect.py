...
# Updated styling: 
# Split into grid: left = video & details (stacked beautifully), right = Narrative.
# Clean layout using borders, subtle typography, and a modern B2B portfolio feeling.
css_content = """
...
def build_ultimate_layout(lang_data):
  ...
  <section class="section" style="padding-top: 140px; padding-bottom: 2rem; background: #fff;">
    <div class="container text-center">
      <h1 style="font-size: 3.5rem; font-family: 'Times New Roman', Times, serif; font-weight: normal; margin-bottom: 1rem;">10 Global Realizations</h1>
      <p style="font-size: 1.15rem; color: #666; max-width: 700px; margin: 0 auto; line-height: 1.7;">A meticulous overview of how we solve complex space and furniture challenges across 10 commercial projects globally.</p>
    </div>
  </section>
'''
...
print("Successfully refined layout architecture.")
